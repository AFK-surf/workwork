...
> {
  ...
  if (!response.ok || body.ok !== true) {
    return {
      ok: false,
      message: typeof body.message === "string" ? body.message : typeof body.error === "string" ? body.error : `GitHub identity resolution failed (${response.status}).`,
    };
  }
