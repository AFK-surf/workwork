...
import { markdownishToMrkdwn, markdownToMrkdwn, markdownToSlackFallbackText } from "../src/services/slack/slack-mrkdwn.js";
...
describe("markdownToSlackFallbackText", () => {
  it("returns converted fallback text when markdown produces mrkdwn", () => {
    expect(markdownToSlackFallbackText("See **status** in [Linear](https://linear.app).")).toBe("See *status* in <https://linear.app|Linear>.");
  });
